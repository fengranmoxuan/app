...
///////////////////////////
route.get('/wangzhanwei/huiben', function (req, res,next) {
    routerUrl('wangzhanwei/huiben','wangzhanwei/huiben.ejs',req,res);
});
...
///////////////////////////
//书柜部分
route.get('/user/download', function (req, res,next) {
    routerUrl('user/download','user/download.ejs',req,res);
});
//书柜部分结束
